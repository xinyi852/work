...
var zhCNText = map[int]string{
	...
	ParamDnsTypeBindError: "记录类型参数信息错误",
	ParamMxBindError:      "MX优先级参数错误，范围1-50",
	ParamTTLBindError:     "TTL参数错误，范围600-60400",
	ParamURLHTTPBindError: "记录值错误，需要以http:// 或者https:// 开头",
	...
	DomainCreateErr:   "域名解析服务创建失败，该域名已被其他用户创建",
	DomainListErr:     "该域名不存在,请检查",
	RecordListErr:     "该记录不存在，请检查",
	RecordModifyErr:   "记录更新失败",
	DomainIsCreateErr: "域名创建失败，该域名已被您创建",
	RecordIsExistErr:  "记录已经存在，请勿重复添加",
	RecordDeleteErr:   "记录不存在，删除失败",
	RecordCreateErr:   "记录创建失败，请检查记录值参数。",
}
